...
export const DATA = {
  ...
  navbar: [
    ...
    { href: "https://drive.google.com/file/d/1FeoaZ7xfn2BK5WU4tKBC_KZP_SOFDwzB/view?usp=sharing" , icon: NotebookIcon, label: "Resume" },
  ],
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/priyanshuranjan16/",
        icon: Icons.linkedin,
